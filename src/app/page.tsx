  ...
  return (
    ...
    >
      ...
      <div className='fixed bottom-0 w-full bg-gradient-to-b from-transparent gap-10 to-black py-10 flex items-center justify-center'>
        <Link href={'https://t.me/+n5EwbAA268A1NGQ1'} target={'_blank'} className={'link-icon'}>
          <TelegramIcon />
        </Link>
        <Link href={'https://medium.com/@smemcg666'} target={'_blank'} className={'link-icon'}>
          <MediumIcon />
        </Link>
        <Link href={'https://twitter.com/SSE_MCG '} target={'_blank'} className={'link-icon'}>
          <TwitterIcon />
        </Link>
        <Link href={'https://github.com/0xMCG'} target={'_blank'} className={'link-icon'}>
          <GithubIcon />
        </Link>
      </div>
    </div>
